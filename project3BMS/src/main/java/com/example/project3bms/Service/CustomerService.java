...
public class CustomerService {
    ...
    private final UserRepository userRepository;
        ...
        public void addCustomer(CustomerDTO customerDTO){
            ...
            User newUser = new User(null,customerDTO.getUsername(),customerDTO.getPassword(),customerDTO.getName(), customerDTO.getEmail(), customerDTO.getRole(),null,null);
            Customer customer = new Customer(null,customerDTO.getPhonenumber(),newUser,null);
